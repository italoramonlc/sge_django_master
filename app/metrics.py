...
def get_sales_metrics():
    ...
    total_sales_value = sum(outflows.quantity * outflows.product.selling_price for outflows in Outflow.objects.all())
    total_sales_cost = sum(outflows.quantity * outflows.product.cost_price for outflows in Outflow.objects.all())
